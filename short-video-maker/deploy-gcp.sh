...
gcloud run deploy "$SERVICE_NAME" \
    ...
    --port 3123 \
    --set-env-vars "DOCKER=true,LOG_LEVEL=info,CONCURRENCY=1,VIDEO_CACHE_SIZE_IN_BYTES=2097152000,WHISPER_MODEL=base.en,TTS_PROVIDER=kokoro,VIDEO_SOURCE=pexels,VEO3_USE_NATIVE_AUDIO=false,VEO_MODEL=veo-3.0-fast-generate-001" \
